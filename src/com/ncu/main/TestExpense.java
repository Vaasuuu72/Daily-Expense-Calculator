...
class Expense{
  ...
  String purpose;   
  static int total;               
  File file=new File("D:\\Projects\\DailyExpenseCalculator\\expenses\\expense.txt");
  File tempFile=new File("D:\\Projects\\DailyExpenseCalculator\\expenses\\expense.txt");
  ...
  //***********************************************************************************
   ...
   //***************************************************************************
    ...
    void expenseCalculate()  {
     String file = "D:\\Projects\\DailyExpenseCalculator\\expenses\\expense.txt"; 
    try  
    { FileReader fr = new FileReader(file);
    ...
    System.out.println("Total Expense till date is : Rs."+total);
    total =0;
  }
public void expenseDelete(){
  boolean i, j;
  String removeTerm;
  String filepath = "D:\\Projects\\DailyExpenseCalculator\\expenses\\expense.txt";
  int positionofterm = 0;
  String tempFile = "D:\\Projects\\DailyExpenseCalculator\\expenses\\temp.txt";
